...
1. **Afficher les choix sur le code final de la classe si vous avez dû faire des changements : Affichez entre autre votre score et le retour de Pylint mais surtout expliquer vos choix d'architecture et de code**
1. **Associer au projet gitlab le README le plus complet possible**
1. **Faire un gros effort sur les commentaires : utilisez intensivement les docstrings (PEP 257) **
