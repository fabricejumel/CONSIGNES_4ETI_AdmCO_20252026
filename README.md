...
1. **Expliquer l'interet et l'usage de venv dasn votre cas (rester simple), dans votre cas (NE PAS JOINDRE DE REPERTOIRE Venv dans votre git ou de fichiers temporaires), Coder la ou les classes et le package associé et les déposer sur test Pypi**
